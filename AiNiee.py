...
if __name__ == "__main__":
    ...
    # 创建多智能体任务执行器（可选，用于多智能体模式）
    update_splash_message(splash, "正在加载多智能体执行器... (80%)", app)
    from ModuleFolders.TaskExecutor.MultiAgentTaskExecutor import MultiAgentTaskExecutor
